...
xdescribe('When we call get on a resource with a config', () => {
...
xdescribe('When we call post on a resource with a config', () => {
  it('Then we get the expected result from server and config.method set to POST', (done) => {
    callApiAndExpect('post', done)
  })
})

xdescribe('When we call put on a resource with a config', () => {
  it('Then we get the expected result from server and config.method set to POST', (done) => {
