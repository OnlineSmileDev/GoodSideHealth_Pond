...
describe('Given we call requestIsAlreadyPending ', () => {
  ...
  describe('When no request are pending ', () => {
    it.skip("And there is noBusySpinner false Then we return false and don't call dispatch ", async () => {
    ...
    it.skip("And there is noBusySpinner true Then we return false and don't call dispatch ", async () => {
      expect(requestIsAlreadyPending).toBeTruthy()
      expect(dispatch.mock).toBeTruthy()
      expect(pendingRequestSelectors.selectPendingRequest.mock).toBeTruthy()
  ...
  describe('When a request is pending but noBusySpinner is passed in ', () => {
    it.skip('Then we dispatch incrementBusyIndicator, dispatch setBusySpinner with busy spinner true and we dispatch REQUEST_ALREADY_PENDING_ASYNC and we return true  ', async () => {
      testIt(
        { noBusySpinner: false },
  ...
  describe('When a request is pending and noBusySpinner is passed in ', () => {
    it.skip('Then we dispatch setBusySpinner with busy spinner true and we dispatch REQUEST_ALREADY_PENDING_ASYNC and we return true  ', async () => {
      testIt(
        { noBusySpinner: true },
