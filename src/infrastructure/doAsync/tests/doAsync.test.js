...
describe('Given we call doAsync ', () => {
  ...
  describe('When validateInput throws ', () => {
    it.skip('Then logError is called and we rethrow exception ', () => {
  ...
  describe('When a request is pending ', () => {
    it.skip('Then actionType.REQUESTED is dispatched and nothing else is dispatched and we return rejectWithValue to caller ', async () => {
      expect(doAsync).toBeTruthy()
  ...
  describe("When arguments are valid and request isn't pending ", () => {
    describe('and the http returns rejected promise', () => {
      it.skip('Then handleError is called ', (done) => {
    ...
    describe('and the httpMethod is GET', () => {
      it.skip('Then actionType.REQUESTED is dispatched and nothing else is dispatched ', async () => {
        const expectedBody = 'expectedBody'
